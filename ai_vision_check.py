...
def check_reversal(image_path, symbol, direction, image_path_5m=None):
    ...
    prompt = (
        ...
        f"LONG: sharp drop + STRONG volume spike at bottom + 3+ green recovery candles AT RIGHT EDGE with increasing momentum. "
        f"SHORT: sharp rally + STRONG volume spike at top + 3+ red declining candles AT RIGHT EDGE with increasing momentum. "
