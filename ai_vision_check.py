...
def check_reversal(image_path, symbol, direction):
    ...
    prompt = (
        ...
        f"LONG: sharp drop + volume spike at bottom + 2+ green recovery candles AT RIGHT EDGE. "
        f"SHORT: sharp rally + volume spike at top + 2+ red declining candles AT RIGHT EDGE. "
