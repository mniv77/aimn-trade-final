...
# run: uvicorn params_api_table:app --host 0.0.0.0 --port 8000 --reload
# deps: fastapi uvicorn pydantic PyMySQL
...
class Key(BaseModel):
    ...
    symbol: str
    timeframe: str = "1h"
    trade_mode: str = Field(regex="^(BUY|SELL)$")
...
class ParamsIn(BaseModel):
    ...
    entry: EntryParams
    exit: ExitParams
    flags: Optional[Dict[str, bool]] = None  # enable_alerts/show_lines/show_signals
